...
def seed_users():
    ...
    demo = User(
        username='DemoCrow', first_name='Crow Presenter', last_name='User', email='demo@aa.io', password='password', profile_image='https://cdn.mos.cms.futurecdn.net/PqHzRT5FnGPSoEUMfmGSWH.jpg', bio='Im just a demo user :)')
