...
def seed_comments():
    ...
    comment20 = Comment(userId=2, cawId=10, data='Not a fan')
    comment21 = Comment(userId=5, cawId=10, data='I guess it is alright')
    comment22 = Comment(userId=6, cawId=10, data='I DO!!!')
    ...
    comment29 = Comment(userId=1, cawId=13, data="I think it's easier")
    comment30 = Comment(userId=5, cawId=13, data='Charcoal > propane')
    comment31 = Comment(userId=7, cawId=13, data='Propane makes the meat taste better')
    ...
    comment53 = Comment(userId=2, cawId=20, data='They just love to get our hopes up')
    comment54 = Comment(userId=9, cawId=20, data='Maybe one day')
    comment55 = Comment(userId=7, cawId=20, data='Bring back MJ')
    comment56 = Comment(userId=3, cawId=21, data='We get it')
