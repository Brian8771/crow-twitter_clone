...
const SmallNavbar = () => {
    ...
    return (
        <>
            <nav className='smallNav absolute bottom-0  flex bg-black w-full  justify-around  h-12 items-center md:hidden'>
                <NavLink className='flex justify-center items-center mt-4' to='/' exact={true} activeClassName='active'>
                ...
                <NavLink className='flex align-center justify-center mt-4' to={`/users/${session.id}`}>
                    <svg className="h-12 w-12">
