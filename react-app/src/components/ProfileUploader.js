...
const UploadProfilePicture = ({ setImg }) => {
    ...
    return (
        <form className=" absolute top-14 left-12" ref={formRef} id="imageForm">
            <div className="image-upload flex">

                <label htmlFor="file-inputs" className="h-12 w-12 flex justify-center items-center rounded-full" style={{ backgroundColor: 'rgba(0 0 0 / .5)' }}>
